...
//  static let availableSpeedValues: [Double] = [-32, -16, -8, -4, -2, -1, 1, 2, 4, 8, 16, 32]
  ...
  static let githubLink = "https://github.com/rawya-ai-player/client-macos"
  static let contributorsLink = "\(githubLink)/graphs/contributors"
  static let crowdinMembersLink = "https://crowdin.com/project/iina"
  static let websiteLink = "https://rawya.app"
  static let helpLink = websiteLink
  static let upstreamDocumentationLink = "https://github.com/iina/iina/wiki"
